...
public class Relacionamento extends Componente{
	...
	public void desenha() {
		...
		if(this.direcaoLeitura == "Direita")
			System.out.println( elementos.get(0).getNome() +"-- " + this.nome + " --> " + elementos.get(1).getNome() );
		
		if(this.direcaoLeitura == "Esquerda")
			System.out.println( elementos.get(1).getNome() +"-- " + this.nome + " --> " + elementos.get(0).getNome() );
